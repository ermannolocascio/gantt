...
A series of emails and notifications are sent to the calendar owner and the client to handle the process. A short demo of the final result is available A short demo of the final result is available [here](https://www.youtube.com/watch?v=IaY0i23od4o){:target="_blank"}.
